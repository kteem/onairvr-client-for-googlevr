# onAirVR Client for Google VR ![current release](https://img.shields.io/github/release/onairvr/onairvr-client-for-googlevr.svg) ![os](https://img.shields.io/badge/os-Android-green.svg)
